...
const Home = () => {
  ...
  const fetchPost = () => {
    setIsAwaiting(false);
    axios
      .post(`http://localhost:8080/study/${params.id}/home`)
      .then((res) => {
      ...
      .then(
        axios
          .post(`http://localhost:8080/study/${params.id}/todoall`)
          .then((res) => {
            if (res.data.message === "success") {
              ...
              <Grid item xs={6}>
                ...
                <Box>
                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      <Typography variant="h4">등급</Typography>
                    </Grid>
                  </Grid>
                  {member.map((el) => (
                    <Grid
                    ...
                    >
                      ...
                      <Grid item xs={6}>
                        {el.id === el.hostid ? (
                          <Typography variant="h6">방장</Typography>
                        ) : (
